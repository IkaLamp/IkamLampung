  ...
  <?php foreach ($hot_news as $br):?>
    ...
    <div class="coll">
            ...
            <div class="card-body d-flex flex-column align-items-start">
               <h3 class="mb-0">
                    <a class="text-dark" href="#"><?php echo $br->judul;?></a>
                </h3>
                <div class="mb-1 text-muted"><?php echo $br->tanggal;?></div>
                <p class="card-text mb-auto"><?php echo word_limiter($br->deskripsi,7);?></p>
                <a href="<?php echo $br->artikel;?>">Lebih lanjut -></a>
            </div>
        </div>
    </div>
        <?php endforeach;?>
